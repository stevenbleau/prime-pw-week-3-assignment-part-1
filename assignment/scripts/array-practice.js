...
let food = ['sushi', 'gumbo', 'pasta', 'pizza'];
...
console.log('Number of favorite foods: ', food.length);
...
console.log('First food is ', food[0]);

// 3.b. TODO: Log the last animal in the array using it's array index 
console.log('Last food is ', food[food.length-1]);
...
// console.log('Added a food to the beginning:', food[0]);
